...
#ifndef brBarParameterisation_h
#define brBarParameterisation_h 1
...
class brBarParameterisation : public G4VPVParameterisation
{ 
  public:
  
    brBarParameterisation(G4int    nBarX, //number of bars in layer, X axis
