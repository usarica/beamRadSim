...
void EDep3(){
    TFile *fproton = new TFile("/media/ryan/Storage/computing/beamRadSim/data/proton/BeamRad1mm.root");
    TFile *felectron = new TFile("/media/ryan/Storage/computing/beamRadSim/data/proton/BeamRad.root");
