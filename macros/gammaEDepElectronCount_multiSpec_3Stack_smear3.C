...
//retreive file
  ...
  TString fileDir = "/media/ryan/Storage/computing/beamRadSim/data/one_or_three_stack_runs/run3data/";
...
//initialize variables
  ...
  double EDep2=0;
  double EDep3=0;
  double countStat1,countStat2,countStat3;
...
//get data in file
  for (Long64_t i=0;i<nentries;i++) {
	...
	smearElec = (int)g1->Gaus(0,100);
//	if(i % 100 == 0) std::cout << "eCount: " << eCount1 << " smear: " << smearCount+smearElec << std::endl;
