...
//  TString absThick = "50um";
  //rootEvents.Add(fileDir+ene+"_"+absThick+"Abs_5stack/BeamRad.root");
  rootEvents.Add(fileDir+"LYSO/BeamRad.root");
...
TFile *out = new TFile(fileDir+"LYSO/GammaECount.root","RECREATE");
