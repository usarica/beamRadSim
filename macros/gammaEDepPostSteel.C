...
//retreive file
  ...
  TString fileDir = "/media/ryan/Storage/computing/beamRadSim/data/eBremData/gammaDepositPostSteel1cm/";
...
//initialize variables
  ...
  double noise = 400;
  int nbins = 200;
TFile *out = new TFile(fileDir+"GammaEDep.root","RECREATE");
  TH1I* hEneDeposit1 = new TH1I("hEneDeposit1","",nbins,0,10001);
  TH1I* hEneDeposit2 = new TH1I("hEneDeposit2","",nbins,0,10001);
  TH1I* hEneDeposit3 = new TH1I("hEneDeposit3","",nbins,0,10001);
  TH1I* hEneDeposit4 = new TH1I("hEneDeposit3","",nbins,0,10001);
  TH1I* hEneDeposit5 = new TH1I("hEneDeposit3","",nbins,0,10001);
...
*/
  ...
  hEneDeposit5->SetTitle("Electron-Hole Pairs Generated in 5-layer Si stack, Post-Steel");
