...
//*/
	...
	G4LogicalVolume* SiBulk_logic = new G4LogicalVolume(
				SiBulk_solid,
				//matPlScin,
				NiMat,
				"SiBulk_logic",
...
G4MaterialPropertiesTable* mptPlScin = new G4MaterialPropertiesTable();
 ...
 const G4int nEntries= 43;//301;//100;
	...
	G4double pSEff;
	ReadEJ200.open("/homes/schmitz/mqSlabSim/OpticalData/EJ200ScintSpectrum.txt");
